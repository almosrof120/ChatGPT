...
class _MyHomePageState extends State<MyHomePage> {
  ...
  List<String> messagesChatGPT = [
    "Hello World! I am prepared to answer (almost) all of your questions. What do you want to ask"
  ];
  String token = "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";
  late final chatGpt;
  late bool available;
        ...
        _speech.listen(
            ...
            onResult: (val) async {
              ...
              var content2 = await textCompletion(
                  val.recognizedWords); // here is the robot's answer
  ...
  void onSendMessage(String content) async {
    ...
    if (content.trim() != '') {
      textEditingController.clear(); //first set the user message
      setState(() {
        messagesChatGPT.add(content);
      });

      var content2 =
          await textCompletion(content); // here is the robot's answer
      setState(() {
        messagesChatGPT.add("${content2?.choices![0].text}");
      });
      ...
      ScaffoldMessenger.of(context)
          .showSnackBar(SnackBar(content: Text("Nada para enviar")));
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            // Message from chatGPT and User alternate
            Flexible(
              child: ListView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  ...
                  return AnimatedAlign(
                    ...
                    duration: reversedIndex == messagesChatGPT.length - 1
                        ? Duration(seconds: 1)
                        : Duration(seconds: 0),
                    alignment: reversedIndex.isEven
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        color: reversedIndex.isEven
                            ? Colors.lightBlueAccent[100]
                            : Colors.greenAccent,
                        borderRadius: reversedIndex.isEven
                            ? BorderRadius.only(
      ...
      floatingActionButton: FloatingActionButton.small(
          ...
          onPressed: () {
            setState(
                () => messagesChatGPT.removeRange(1, messagesChatGPT.length));
          }),
...
class _MeuAppBarState extends State<MeuAppBar>
  ...
  void initState() {
    ...
    _animation =
        Tween<double>(begin: 0.7, end: 1.2).animate(_animationController);
      ...
      child: ClipShadow(
        ...
        child: Container(
          height: MediaQuery.of(context).size.height *
              .5, //here I change the size of the little orange, but it only goes up to the maximum size of Size()
...
class Clipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.lineTo(
        1,
        size.height -
            130); //path.lineTo(0, MediaQuery.of(context).size.height *.25 - 150);//
